...
const sparkleDuration = props.sparkleDuration || 20;

const getRandomSize = () => {
  const sizes = [
    { width: '20px', height: '20px', class: 'small' },
    { width: '30px', height: '30px', class: 'medium' },
    { width: '50px', height: '50px', class: 'large' },
  ];
...
.shine {
  ...
  opacity: 0;
  animation: glitter 6s linear infinite normal;
  z-index: 2;
}
